...
def init():
    ...
    parser.add_argument('--path_to_PARA_images', type=str, default='E:\\PARA\\imgs', help='directory to images')

    parser.add_argument('--path_to_PARA_save_csv', type=str,default="./PARA_data/",help='directory to csv_folder')
